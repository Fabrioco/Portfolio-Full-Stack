...
export function Profile() {
  return (
    ...
    >
      <p className="absolute -top-3 -right-5 bg-main text-black px-4 py-2 rounded-md rounded-bl-none w-fit font-bold flex items-center gap-2 z-10">
        Oi, eu sou Fabrício
        <i>
      ...
      <Image
        ...
        width={500}
        height={500}
        className="w-full h-full rounded-full rotate-[35deg] object-cover"
      />
    </motion.div>
  );
}
